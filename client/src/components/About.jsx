        ...
        <div className="flex flex-col lg:flex-row text-white mt-24 lg:mt-0 md:space-y-10">
          ...
          >
            ...
            <h1 className="about front text-center text-gradient lg:text-left text-base px-7 md:text-xl">
              Welcome to my digital universe! I am Arvidas a career shifter,
              navigating the endless possibilities of web and app development.
              Ever since I developed a strong interest in technology through
              reading and staying updated on the latest tech trends, I am now
              taking concrete steps towards a career in the tech industry. To
              turn my dream of becoming a developer into reality, I employ two
              distinct approaches: a bootcamp and self-study. Although my tech
              knowledge is centered around the MERN stack. I remain open to
              exploring other technologies as well, and the first on my list is
              probably Python and PostgreSQL.
            </h1>
          </motion.div>
        </div>
